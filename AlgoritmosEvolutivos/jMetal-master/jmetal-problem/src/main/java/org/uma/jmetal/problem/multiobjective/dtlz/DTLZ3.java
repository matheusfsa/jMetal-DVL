...
public class DTLZ3 extends AbstractDoubleProblem {
  ...
  public double[] evaluate2(double[] solution) {
	    int numberOfVariables = getNumberOfVariables();
	    int numberOfObjectives = getNumberOfObjectives();
	    double[] f = new double[numberOfObjectives];
	    double[] x = new double[numberOfVariables] ;
  ...
  public static void main(String[] args) {
	double[] sol = {0.18764439438674288, 0.1802626507583047, 0.43427668321390056, 0.4370016505168144, 0.4359621636148334, 0.43554108472324926, 0.43639355599485086, 0.43633400409843237, 0.43358424695865627, 0.43486710878745827, 0.43496328698129094, 0.43368982137489087};
	DTLZ3 d = new DTLZ3(12, 3);
	System.out.println(Arrays.toString(d.evaluate2(sol)));
  }
}
