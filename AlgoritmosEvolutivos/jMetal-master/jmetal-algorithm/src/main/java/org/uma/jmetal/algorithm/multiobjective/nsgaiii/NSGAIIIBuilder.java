...
public class NSGAIIIBuilder<S extends Solution<?>> implements AlgorithmBuilder<NSGAIII<S>>{
  ...
  private GeneratorOperator<S> generatorOperator ;
...
public NSGAIIIBuilder<S> setPopulation(List<S> population) {
	this.population = population;
	return this;
}

public NSGAIIIBuilder<S>  setGeneratorOperator(GeneratorOperator<S> generatorOperator) {
